 ...
 * @subpackage Wdv_About_Me_Widget/public
 */
 ...
 */
class Wdv_About_Me_Widget_Public {
	...
	public function enqueue_styles() {
		 ...
		 */
                ...
                wp_enqueue_style( 'fontawesomepublic', plugin_dir_url( __FILE__ ) . '../includes/fonts/css/v4-shims.min.css', array(), '5.9.0', 'all' );                               
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wdv-about-me-widget-public.js', array( 'jquery' ), $this->version, false );
